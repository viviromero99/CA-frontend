...
import { updateProject, updateCandidaturas } from '../../services/professorApi';
import { AuthContext } from '../../contexts/newAuth';


export default function AbrirProjetoScreen({route, navigation}){
    ...
    async function handleUpdate(){
        ...
        try{
          ...
          if (response.status == 200){
                await updateCandidaturas(projeto.usuarioCpf, projeto.id, {selecionado: false});
