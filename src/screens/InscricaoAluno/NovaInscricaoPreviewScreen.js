...
export default function NovaInscricaoPreviewScreen({route, navigation}){
    ...
    return(
        <View style = {styles.container}>
            ...
            <View style={{marginTop: 20, marginBottom: 30}}>
                <TouchableOpacity style = {styles.button} onPress={() => {navigation.navigate("Criterios", {projeto: projeto})}}>
