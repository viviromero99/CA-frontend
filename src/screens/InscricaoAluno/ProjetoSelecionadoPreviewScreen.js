...
export default function ProjetoSelecionadoPreviewScreen({route, navigation}){
        ...
        <View style = {styles.container}>
            ...
            <ScrollView style={styles.detailsContainer}>
                ...
                <View style={styles.content}>
                    <Text style = {styles.text}>Contato do Orientador:</Text>
                    <Text style = {styles.subtext}>{projeto.email}</Text>
                </View>
            ...
            <View style={{marginTop: 20, marginBottom: 30}}>
                <TouchableOpacity style = {styles.button} onPress={() => navigation.navigate("Inscricao", {screen: "InscricaoSelecionadaPreview", params: {projeto: projeto}})}>
